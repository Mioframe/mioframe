/** Attribute carrying the stable item id of a reorder item element. */
export const REORDER_ITEM_ATTRIBUTE = 'data-sortable-id';
/** Attribute used to mark controls and subtrees that must not start reorder. */
export const REORDER_IGNORE_ATTRIBUTE = 'data-sortable-ignore';
/** Class applied to the surface while reorder activation is in progress. */
