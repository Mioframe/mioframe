...
| Viewport/background sandbox     | global desktop/mobile viewports and app/surface Material-token backgrounds are configured and freely selectable; the default remains the plain Canvas, never checkerboard             |
