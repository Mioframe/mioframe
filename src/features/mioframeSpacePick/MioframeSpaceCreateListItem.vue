...
<template>
  ...
  >
    ...
    <div class="mioframe-space-create-list-item__details">
      <p class="mioframe-space-create-list-item__detail">
        Selected location: {{ selectedLocation }}
      </p>

      <p class="mioframe-space-create-list-item__detail">Space folder: {{ resultFolder }}</p>
    </div>
  </MDDialog>
</template>

<style scoped>
.mioframe-space-create-list-item {
  &__details {
    display: grid;
    gap: 8px;
  }
