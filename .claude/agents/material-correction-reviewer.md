---
name: material-correction-reviewer
description: Use only when the Material orchestrator requests an independent correction-final review of one implemented correction unit.
