...
import { reportDiagnosticEvent, setDiagnosticEventForwarder } from '@shared/lib/diagnostics';
...
/**
 * Sets up proxy-based forwarding of diagnostic events from the worker context
 * to the main-thread diagnostics service.
