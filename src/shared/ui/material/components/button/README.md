...
- boolean loading presentation retained for confirmed short indeterminate operations;
...
| Boolean loading presentation                          | selected library surface for confirmed short indeterminate operations; no current production consumer | `loading?: boolean`                                                                             | `partial` — Button composes canonical `MDLoadingIndicator`                             | Button — `implement-now`                                                      | unit + browser + visual                 |
...
| Legacy Material surface context                       | current Buttons render inside `.md` surfaces that provide inherited ordinary content color            | no Button API or consumer reset; Button and composed indicator keep component-owned color       | `direct` — native inheritance plus renderer/component ownership                        | legacy surface and component owners — `implement-now`                         | source contract + browser + visual      |
