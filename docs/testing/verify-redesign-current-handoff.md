...
The repository is prepared for this assignment. The coding agent must start from the latest `architecture/verify-redesign` head, not from an earlier merge/CI SHA.
