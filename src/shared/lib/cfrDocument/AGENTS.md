...
- Minimum verification: run `pnpm verify --only static`, then verify the touched legacy caller still loads and migrates the relevant document or repo state through focused verify-managed coverage.
