...
const switchStatesTemplate = `
  <div data-testid="visual-md-switch-states" class="visual-list-backdrop">
...
const switchInteractionStatesTemplate = `
  <div data-testid="visual-md-switch-interaction-states" class="visual-list-backdrop">
    <div class="visual-row">
...
const targetHitAreaTemplate = `
  <div id="visual-md-switch-target-hit" class="visual-list-backdrop">
    <MDSwitch
