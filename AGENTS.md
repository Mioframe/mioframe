...
- Do not add handwritten `-webkit-*` CSS hacks to shared UI runtime styles without a documented compatibility decision and cross-browser verification; prefer the standard CSS property.
