...
- Minimum verification: run `pnpm verify --only static`, then verify subscribe, initial value, update, unsubscribe, resubscribe, and dedupe behavior for the touched key shape through focused verify-managed tests.
