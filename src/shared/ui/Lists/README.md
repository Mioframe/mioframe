...
Public token names map mechanically from the documented Material path, per [Material component token policy](../material/docs/component-tokens.md):
...
| `--md-comp-list-list-item-selected-disabled-container-color`                                         | `md.comp.list.list-item.selected.disabled.container.color`       | Disabled selected container color role; raw `on-surface`, no alpha baked in. Alpha is composed in `--md-private-list-item-selected-disabled-container-color` |
...
| `--md-comp-list-list-item-disabled-leading-icon-color`                                               | `md.comp.list.list-item.disabled.leading-icon.color`             | Disabled leading icon color                                                                                                                                  |
...
| `--md-private-list-item-selected-disabled-container-color` | (resolved)                  | —           | Alpha-composed `rgb(from on-surface ... / 0.38)` actually painted for the selected+disabled row background; same color/opacity split as the disabled label/icon/text private tokens above                                                                                                                                                                                                                |
