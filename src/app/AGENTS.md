...
- Minimum verification: run `pnpm verify --only static`, then exercise cold start into the default route, deep-link into the touched route, and refresh that route.
