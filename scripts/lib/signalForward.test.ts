...
import { createChildSignalForwarder, type ChildSignalForwarder } from './signalForward.ts';

const forwarders: ChildSignalForwarder[] = [];
 ...
 */
function emitParentSignal(forwarder: ChildSignalForwarder, signal: NodeJS.Signals): void {
