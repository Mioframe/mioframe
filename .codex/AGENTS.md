...
- Bias hooks toward additive context, precise Bash guardrails, and early guidance. Leave durable enforcement to `memory:task:finish` and repo-local validation, not to `git commit`, `git push`, or stop-time traps.
