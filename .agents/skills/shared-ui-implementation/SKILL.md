...
Do not use this skill as the primary workflow for an official Material family, Vue-to-m3e implementation, or Material family migration. Use `material-component <name>` and the scoped `src/shared/ui/material/AGENTS.md` contract-first workflow instead. When Material implementation proves that a responsibility belongs in a separate non-MD shared component, apply this skill only to that separately owned component.
...
It does not own official Material family contracts, m3e integration, Material token mapping, global theme ownership, canonical Material consumer migration, or Material family review.
