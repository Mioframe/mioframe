...
- Check the project's browserslist target before assuming a vendor prefix is still required — many historically-prefixed properties (e.g. `line-clamp`) now have broadly supported standard forms within "last 3 years, not dead".
