 ...
 */
export function findColocatedVisualSpecFiles(dir = COLOCATED_VISUAL_SPEC_ROOT_DIR) {
 ...
 */
export function isColocatedVisualSpecPath(filePath) {
  return (
 ...
 */
export function isLegacyVisualPath(filePath) {
 ...
 */
export function isFullVisualLanePath(filePath) {
 ...
 */
export function isBroadVisualRelevantPath(filePath) {
  return (
 ...
 */
function getColocatedVisualSpecOwnerRoot(specPath) {
 ...
 */
function findColocatedVisualSpecOwners(filePath, colocatedSpecs) {
 ...
 */
function getColocatedVisualSnapshotSpecCandidate(filePath) {
 ...
 * owner-local `*.visual.spec.ts` paths, bypassing filesystem discovery under
 * `src/`. Production callers should omit this so real colocated ownership is
 * resolved against the repository state.
