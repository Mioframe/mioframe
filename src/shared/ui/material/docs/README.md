...
- [`component-development.md`](./component-development.md) — the only staged implementation workflow for one component family;
...
Implementation uses `material-component`. Review-only assessment uses `material-component-review`; it reports findings without creating a second workflow or durable audit artifact.
