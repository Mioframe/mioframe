...
Generic diagnostics infrastructure lives in `src/shared/lib/diagnostics`. The Sentry facade and runtime live in `src/shared/lib/diagnostics/sentryRuntime.ts`.
