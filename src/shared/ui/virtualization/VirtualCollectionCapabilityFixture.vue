 ...
 * rendering, dynamic measurement, stable-key remapping, and deep-scroll geometry contracts using
 * ordinary consumer-owned `<ul>/<li>` markup and the returned measurement directive.
 */
...
const collection = useVirtualCollection(order, {
